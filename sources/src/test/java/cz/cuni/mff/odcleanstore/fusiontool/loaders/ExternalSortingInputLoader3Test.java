...
public class ExternalSortingInputLoader3Test {
    // TODO
    ...
    public void iteratesOverAllStatementsWithAppliedUriMapping() throws Exception {
        ...
        ExternalSortingInputLoader3 inputLoader = createExternalSortingInputLoader(testInput1, false);
        try {
    ...
    public void nextQuadsReturnsCompleteConflictClusters() throws Exception {
        ...
        ExternalSortingInputLoader3 inputLoader = null;
        try {
    ...
    public void worksOnEmptyStatements() throws Exception {
        // Act & assert
        ExternalSortingInputLoader3 inputLoader = createExternalSortingInputLoader(Collections.<Statement>emptySet(), false);
        try {
            inputLoader.initialize(uriMapping);
    ...
    public void clearsTemporaryFilesOnError() throws Exception {
        ...
        try {
            ...
            inputLoader = new ExternalSortingInputLoader3(dataSources, testDir.getRoot(),
    ...
    public void readsMultipleInputFiles() throws Exception {
        // Act
        SortedSet<Statement> result = new TreeSet<Statement>(SPOG_COMPARATOR);
        ExternalSortingInputLoader3 inputLoader = new ExternalSortingInputLoader3(
    ...
    public void iteratesOverAllStatementsWithAppliedUriMappingWithDependentResources() throws Exception {
        // Act
        SortedSet<Statement> result = new TreeSet<Statement>(SPOG_COMPARATOR);
        ExternalSortingInputLoader3 inputLoader = createExternalSortingInputLoader(testInput3, false);
        try {
            collectResult(inputLoader, result);
        } finally {
            inputLoader.close();
    ...
    private ExternalSortingInputLoader3 createExternalSortingInputLoader(Collection<Statement> testInput, boolean outputMappedSubjectsOnly) throws IOException, RDFHandlerException {
        return new ExternalSortingInputLoader3(
    ...
    private void collectResult(ExternalSortingInputLoader3 inputLoader, Set<Statement> result) throws ODCSFusionToolException {
        inputLoader.initialize(uriMapping);
        while (inputLoader.hasNext()) {
            result.addAll(inputLoader.nextQuads());
        }
