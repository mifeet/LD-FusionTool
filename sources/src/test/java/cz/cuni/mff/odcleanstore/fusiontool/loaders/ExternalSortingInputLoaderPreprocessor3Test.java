...
public class ExternalSortingInputLoaderPreprocessor3Test {
    ...
    public void respectsSetContext() throws Exception {
        ...
        ExternalSortingInputLoaderPreprocessor3 preprocessor = new ExternalSortingInputLoaderPreprocessor3(
