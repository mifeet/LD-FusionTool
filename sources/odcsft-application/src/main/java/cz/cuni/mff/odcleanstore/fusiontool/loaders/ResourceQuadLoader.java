 ...
 */
public interface ResourceQuadLoader extends Closeable<LDFusionToolException> {
    /**
     ...
     */
    void loadQuadsForURI(String uri, Collection<Statement> quadCollection) throws LDFusionToolException;
}
